...
👋 Hey, thanks for taking an interest in 🏁 React Final Form HTML5 Validation!
...
<!-- Include 🏁 React Final Form HTML5 Validation version, 🏁 Final Form HTML5 Validation version, 🏁 Final Form version, OS/browser affected, Node version, etc. -->
